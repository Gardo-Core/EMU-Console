...
export function BehaviorTab() {
  return (
    <div className="space-y-6">
      ...
      >
        <h3 className="text-sm font-bold text-emu-highlight mb-6">Esecuzione e logica UI</h3>
      ...
      <motion.div 
        ...
        className="bg-[#1A4645]/30 backdrop-blur-md rounded-xl border border-[#266867]/50 p-6 shadow-xl relative z-10 focus-within:z-50 hover:z-20 transition-all duration-300"
      >
        <h3 className="text-sm font-bold text-emu-highlight mb-6">Blocco configurazione</h3>
        <div className="grid grid-cols-12 gap-y-6 gap-x-4">
          <FormInput 
            name="cfgPassword" 
