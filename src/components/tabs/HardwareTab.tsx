    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-12 gap-y-6 gap-x-4">
          ...
          <ToggleSwitch name="barcodeShow" label="Visual Feedback" tooltip="Briefly display the scanned barcode text on screen." />
          <ToggleSwitch name="barcodeUseKeymap" label="Use Keyboard Map" tooltip="Run the scanned result through the custom keyboard mappings before transmission." />
        </div>
      </motion.div>
